...
<?php
$title = "Contact Us - SwissLife Pharmaceuticals";
$description = "Get in touch with SwissLife Pharmaceuticals for all your healthcare needs.";
?>
...
?>
                ...
                ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <input type="submit" value="Send Message" style="background-color:#c16c19;color:#fff;" class="btn pull-right" name="form_contact">
                                </div>
                            </div>
                            </form>
                        </div>
