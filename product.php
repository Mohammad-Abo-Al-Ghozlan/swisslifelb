			...
			<div class="col-md-12">
				...
				<div class="product">
					<div class="row">
						...
						<div class="col-md-7">
							<div class="p-title"><h2><?php echo $p_name; ?></h2></div><br>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<ul class="nav nav-tabs" role="tablist">
								<li role="presentation" class="active"><a href="#feature" aria-controls="feature" role="tab" data-toggle="tab"><?php echo LANG_VALUE_60; ?></a></li>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="product-carousel">
                    ...
                    <a href="tel:+0096103155211"><i class="fa fa-phone"></i></a>
                    <a href="http://wa.me/+0096103155211"><i class="fa-brands fa-whatsapp"></i></a>
                </div>
                            </div>
                        </div>
                        <?php
